  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
        <div className='flex flex-col items-center bg-blue-100 py-4 rounded-lg shadow-md'>
          <div className='rounded-full bg-indigo-100 flex justify-center items-center w-12 h-12'>
          ...
          <p className="text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum, vero quod consequatur ea officia magni. Totam vel modi quis aut sed nihil, cupiditate itaque dolores delectus laboriosam, corporis tenetur numquam.</p>
        </div>
