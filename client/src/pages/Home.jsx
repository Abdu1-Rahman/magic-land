...
const Home = () => {
  ...
  return (
    <div className={`fade-in ${isLoaded ? 'loaded' : ''}`}>
      ...
      <Link><button className='p-3 flex gap-2 text-gray-700 bg-blue-100 hover:bg-blue-200 ml-auto mr-8'>See all properties<FaArrowRightLong className='mt-1'/></button></Link>
      </div>
